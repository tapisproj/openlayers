        ...
        "wps": {
            ...
            "Body": function(body) {
                ...
                if (body.wcs) {
                    ...
                    var wfsReq = this.writeNode("wfs:GetFeature", body.wfs);
                    var wfsReqStr = new OpenLayers.Format.XML().write(wfsReq);
                    node.appendChild(
                        this.getXMLDoc().createCDATASection(wfsReqStr)
                    );
                } else {
